...
<head>
  <meta charset="UTF-8">
  <title>ADMIN | Painel de gerenciamento</title>
    ...
    <div class="login-box-body">
      ...
      <?php
        ...
        <form action="<?php echo base_url(); ?>createPasswordUser" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Redigite a senha" name="cpassword" required />
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-8">
