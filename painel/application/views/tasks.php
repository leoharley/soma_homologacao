<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-users"></i> Todas as Missões
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                <thead>
                  <tr>
                    ...
                    <th> Autoridade de usuário criador </th>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a class="btn btn-sm btn-info" href="<?php echo base_url().'editOldTask/'.$record->id; ?>" title="Editar">
                      ...
                      <td class="text-center">
                        <a class="btn btn-sm btn-primary" href="<?= base_url().'endTask/'.$record->id; ?>" title="Finalizar tarefa">
