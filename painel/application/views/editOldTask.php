...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-users"></i> Gerenciamento de tarefas
                <small>Adicionar / Editar Tarefa</small>
            </h1>
        </section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Digite as informações do trabalho</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <form role="form" id="addNewTask" action="<?php echo base_url() ?>editTask" method="post" role="form">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fname">Título da tarefa</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="role">Prioridade</label>
                                            <select class="form-control required" id="priority" name="priority">
                                                <option value="0">Escolha prioridade</option>
                                                <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="comment">Descrição da tarefa</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="status" name="status">
                                                        <option value="0">Defina o status</option>
                                                        <?php
