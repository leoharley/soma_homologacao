<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-users"></i> Histórico do log de backup
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"> O tamanho da tabela de log de backup:
              <?php
            ...
            <div class="pull-right">
              <a class="btn btn-danger" href="<?php echo base_url(); ?>backupLogTableDelete">Limpar tabela de backup</a>
            </div>
            <div class="box-tools">
            </div>
          </div>
