...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from('tb_cadastro_atividade as cadAtiv');
        $this->db->join('tb_cadastro_pessoa as cadPessoa','cadPessoa.co_seq_cadastro_pessoa = cadAtiv.co_cadastro_pessoa');
        $this->db->join('tb_modalidade as modalidade','modalidade.co_seq_modalidade = cadAtiv.co_modalidade');
        $this->db->join('tb_status_atividade as status','status.co_seq_status_atividade = cadAtiv.co_status_atividade');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }

    function carregaInscricoes()
    {
        $this->db->select('*');
        $this->db->from('rl_inscricao as inscr');
        $this->db->join('tb_cadastro_pessoa as cadPessoa','cadPessoa.co_seq_cadastro_pessoa = inscr.co_cadastro_pessoa');
        $this->db->join('tb_cadastro_atividade as cadAtiv','cadAtiv.co_seq_cadastro_atividade = inscr.co_cadastro_atividade');
        $this->db->join('tb_status_atividade as status','status.co_seq_status_atividade = cadAtiv.co_status_atividade');
        $this->db->join('tb_situacao_na_atividade as sitatividade','sitatividade.co_seq_situacao_na_atividade = inscr.co_situacao_na_atividade');
        $this->db->join('tb_modalidade as modalidade','modalidade.co_seq_modalidade = cadAtiv.co_modalidade');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    ...
    function carregaAlunos()
    {
        ...
        $this->db->join('tb_status_cadastro as statusCad','statusCad.co_seq_status_cadastro = cadPessoa.co_status_cadastro');
        $this->db->where('tp_cadastro', 'aluno');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }
    ...
    function carregaProfessores()
    {
        ...
        $this->db->from('tb_cadastro_pessoa as cadPessoa');
        $this->db->join('tb_status_cadastro as statusCad','statusCad.co_seq_status_cadastro = cadPessoa.co_status_cadastro');
        $this->db->where('tp_cadastro', 'professor');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tb_localidade as localid');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tb_modalidade as modalid');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }

    function carregaFormParq()
    {
        $this->db->select('*');
        $this->db->from('tb_formulario_parq as parq');
        $this->db->join('tb_cadastro_pessoa as cadPessoa','cadPessoa.co_seq_cadastro_pessoa = parq.co_cadastro_pessoa');
        $query = $this->db->get();
        $result = $query->result();        
        return $result;
    }
